...
class Constants {
  static const int kNewVersion = 1;
  static const String kAppStoreUrlEn =
      'https://apps.apple.com/us/app/my-right-to-stay/id6743101244';
  static const double kToolbarHeight = 0.09;
  ...
  // Consul app colors
  static const Color kBackgroundColor = Color(0xFF9A2146);
  static const Color kIconColor = Color(0xFF9D2147);
  static const Color kMenuColor = Color(0xFF621231);
  static const Color kGreenButtonColor = Color(0xFF1C5B52);
  static const Color kRedButtonColor = Color(0xFFC20117);
  static const Color kGoldButtonColor = Color(0xFFA67F2D);
  static const Color kLightGoldButtonColor = Color(0xFFFFF2DA);
  static const Color kLightYellowColor = Color(0xFFFFFAF5);
  // theme constants
